...
class MarketEvidence:
    ...
    def __post_init__(self) -> None:
        ...
        for name, value in (("expected_return", self.expected_return), ("confidence", self.confidence), ("maximum_adverse", self.maximum_adverse), ("edge_after_costs", self.edge_after_costs), ("agreement", self.agreement)):
...
class FlowPolicy:
    ...
    def __post_init__(self) -> None:
        ...
        for name, value in (("minimum_confidence", self.minimum_confidence), ("minimum_agreement", self.minimum_agreement)):
...
def assess_flow(profile: InstrumentProfile, evidence: MarketEvidence, policy: FlowPolicy | None = None) -> FlowAssessment:
