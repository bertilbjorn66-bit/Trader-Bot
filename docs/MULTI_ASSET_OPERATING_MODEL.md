...
The portfolio allocator is downstream of domain research. It does not improve or reinterpret a domain signal. It only decides whether a ready opportunity can receive bounded risk under portfolio limits.
